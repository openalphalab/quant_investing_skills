...
# Canonical source: .claude/skills/fetching-fund-universe/scripts/fund_holdings.py
# Refresh this copy with: python tools/sync_vendored.py
# Verify in CI with:     python tools/sync_vendored.py --check
# <<< VENDORED <<<
